...
if ! getent passwd arch; then
    touch /etc/subuid
    touch /etc/subgid
    /usr/bin/useradd --comment 'Arch User' --create-home --user-group --uid 1000 --shell /bin/zsh --non-unique arch
    /usr/bin/usermod --groups adm,wheel arch
    ...
    install -m 700 -o arch -g arch /usr/share/oh-my-zsh/templates/zshrc.zsh-template /home/arch/.zshrc
    install -m 740 -o arch -g arch /tmp/.p10k.zsh /home/arch/.p10k.zsh
